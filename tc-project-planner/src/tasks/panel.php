...
<div class="panel" id="<?php echo $panel_id ?>">
  ...
  <div class="<?php echo $bgclass; ?>" style="padding: 5px; display: flex; flex-direction: row; justify-content: flex-end;">
    <button onclick="updateTask(<?php echo $row->id?>)" style="padding: 5px; margin-left: 10px;">Update</button>
    <button onclick="removeTaskEntry(<?php echo $row->id?>)" style="padding: 5px; margin-left: 10px;">Remove</button>
  </div>
</div>
